...
async function main() {
  ...
  // ── 1. PRODUCTOS ─────────────────────────────────────────────────────────
  console.log("1/6  Creando productos...");
  const productos = [
  ...
  // ── 2. ADMINISTRADOR ────────────────────────────────────────────────────
  console.log("2/6  Creando administrador...");
  ...
  // ── 3. BASES + REMITENTES ───────────────────────────────────────────────
  console.log("3/6  Creando bases y remitentes...");
  const bases: { id: string; nombre: string; lat: number; lng: number; pista: string }[] = [
  ...
  const remitentes = [
    { id: "remitente-bahia", baseIdx: 0 },
    { id: "remitente-mdp", baseIdx: 1 },
    { id: REMITENTE_CLERK_ID, baseIdx: 2 },
  ];
  ...
  for (const r of remitentes) {
    ...
    await prisma.remitente.upsert({
      ...
      update: {},
      create: { id_remitente: r.id, id_base: bases[r.baseIdx].id },
    });
  }
  console.log(`   ${bases.length} bases, ${remitentes.length} remitentes`);

  // ── 4. SOLICITANTES ─────────────────────────────────────────────────────
  console.log("4/6  Creando solicitantes...");
  const solicitantes = [
  ...
  // ── 6. SOLICITUDES ──────────────────────────────────────────────────────
  console.log("6/6  Creando solicitudes...");
  ...
  console.log(`Resumen: Admin=1, Productos=${productos.length}, Bases=${bases.length}, Remitentes=${remitentes.length}, Solicitantes=${solicitantes.length}, Stock=${stocks.length}, Solicitudes=${creadas}`);
}
