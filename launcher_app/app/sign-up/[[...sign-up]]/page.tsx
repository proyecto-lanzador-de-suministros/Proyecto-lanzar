...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const res = await registrarseAction({
      email,
      password,
      nombre,
      rol,
    ...
    <main className="flex min-h-screen items-center justify-center bg-gray-50 dark:bg-slate-950 p-4">
      ...
      >
        <div className="mb-6 text-center">
          <h1 className="text-xl font-bold text-[#1A1A2E] dark:text-white">Crear cuenta</h1>
          <p className="text-xs text-[#6B7280] mt-1">Completá los datos para registrarte</p>
        </div>
